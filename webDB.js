...
webDB.setupTables = function () {
  html5sql.process(
    'CREATE TABLE IF NOT EXISTS articles (id INTEGER PRIMARY KEY, title VARCHAR(255) NOT NULL, author VARCHAR(255) NOT NULL, authorUrl VARCHAR(255) NOT NULL, category VARCHAR(225) NOT NULL, publishedOn DATETIME, body TEXT NOT NULL);',
    function() {
      // on success
